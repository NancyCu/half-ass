...
export const workoutLibrary: WorkoutLibraryEntry[] = [
  {
    ...
    bpm: 'Mostly 130-143 bpm after an easy Zone 1 start.',
    pace: 'Usually 10:45-11:30/mi, slower if HR climbs.',
  ...
  },
  {
    ...
    bpm: 'Warm up in Z1, then live mostly at 130-143 bpm.',
    pace: 'Usually 10:45-11:30/mi once settled.',
    avoid: 'Do not drift into 144-154 bpm just because the pace feels easy.',
  },
  {
    type: 'recovery',
    name: 'Recovery Run',
  ...
  },
  {
    ...
    bpm: 'Mostly 130-143 bpm, final block 155-161 bpm.',
    pace: 'Easy at 10:45-11:30/mi, final block around 8:15-8:30/mi.',
  ...
  },
  {
    ...
    bpm: 'Reps can touch 164-171+ bpm; recover back toward Z1.',
    pace: 'Reps around 7:30-8:00/mi or faster when short.',
  ...
  },
  {
    ...
    bpm: 'Hard uphill effort, often 171+ bpm near the end of reps.',
  ...
  },
  {
    ...
    bpm: 'Work blocks at 155-161 bpm.',
    pace: '8:15-8:30/mi on the work blocks.',
  ...
  },
  {
    ...
    bpm: 'Reps can reach 171+ bpm.',
    pace: 'Faster than 7:15/mi when terrain allows.',
  ...
  },
  {
    ...
    bpm: '164-169 bpm on reps.',
    pace: '7:30-8:00/mi on reps.',
  ...
  },
  {
    ...
    bpm: 'Most miles under 143 bpm; surges may climb briefly.',
  ...
  },
  {
    ...
    bpm: 'Mostly 130-143 bpm, final miles 155-161 bpm.',
    pace: 'Long-run easy pace, then 8:15-8:30/mi finish.',
